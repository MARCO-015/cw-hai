...
BOT_TOKEN = "7280192887:AAF5fS8c4yC4Or6w-SG-eNBjmTDHPsvdnCY"
API_ID = "21258655"
            ...
            for item in batch_class:
                ...
                try:
                    ...
                    if lessonUrl and lessonExt == 'brightcove':
                        token_url = "https://elearn.crwilladmin.com/api/v7/livestreamToken"
...
async def career_will(app, message):
    ...
    topic_url = f"https://elearn.crwilladmin.com/api/v7/batch-topic/{raw_text2}?type=class"
    try:
